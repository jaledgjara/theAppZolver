...
import { TabbedReservationFilters } from '@/appSRC/reservations/Screens/MenuFilterReservation';
import { ReservationCard, ReservationCardProps } from '@/appSRC/reservations/Screens/ReservationCard';
...
const Reservations = () => {
  ...
  const [currentFilter, setCurrentFilter] = useState<ReservationFilter>('upcoming');  
    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) =>           
          <ReservationCard
            {...item}
            onPress={() => router.push(`(client)/(tabs)/reservations/ReservationDetailsScreen/${item.id}`)}
          />
        }
