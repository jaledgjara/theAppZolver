...
import ReservationDetailsCard from '@/appSRC/reservations/Screens/ReservationDetailsCard';
...
const ReservationDetailScreen = () => {
  ...
  const [reservation, setReservation] = useState<ReservationCardProps | null>(null);
  ...
  if (!reservation) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.text}>Reserva no encontrada ({reservationId}).</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      <ToolBarTitle
        titleText="Detalle de la Reserva"
        showBackButton={true}
      />
