        ...
        <ScrollView contentContainerStyle={{ padding: 20 }}>
          ...
          <View style={styles.infoBox}>
            <Text style={styles.infoText}>
              Estás enviando una propuesta oficial. El cliente podrá aceptarla directamente desde el
              chat.
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  infoText: { ...FONTS.caption, color: COLORS.textSecondary },
  label: {
    ...FONTS.bodyMedium,
  ...
  submitButtonText: { ...FONTS.bodyMedium, color: COLORS.white },
});
