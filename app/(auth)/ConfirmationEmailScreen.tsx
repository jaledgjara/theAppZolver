...
const ConfirmationEmailScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <ToolBarTitle titleText="Verificación del email" showBackButton={true} />
      <View style={styles.contentContainer}>
        {loading ? (
          ...
          <StatusPlaceholder
            ...
            subtitle="Te enviamos un enlace para confirmar tu correo electrónico. Abrilo desde tu dispositivo para continuar con tu cuenta de NexoFix."
          />
        )}
      </View>
    </View>
